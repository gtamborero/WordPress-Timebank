...
<div class="timebank">
	...
	<input name="option" type="hidden" value="edit" />
		...
		<td class="explain">min. (<?php _e('Default exchange limit for new users', 'timebank'); ?>) </td><tr />
...
.timebank table th {border:0px; background-color:#888; padding:7px; font-weight:bold; color:#FFFFFF; }
